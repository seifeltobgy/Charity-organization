	...
	<body>
		...
		<div class="fh5co-hero">
			<div class="fh5co-cover text-center" data-stellar-background-ratio="0.5" style="background-image: url(images/cover_bg_1.jpg);">
			  ...
			  <input Type="email" class="form-control" data-val="true" data-val-email="The Email field is not a valid e-mail address." data-val-required="The Email field is required." id="Email" name="Email" placeholder="Email" required="true" type="text" value="" />
                    
              <input class="mobile-num form-control text-left" id="Phone" name="Phone" placeholder="Phone Number"  required="required" title="The phone number is required" type="text" value="" />
                    
              <input Type="text" class="form-control" data-val="true" data-val-required="The Amount field is required." id="amount" name="amount" placeholder="Amount" required="true" type="text" value="" />
                    
              <input Type="Address" class="form-control" data-val="true" data-val-required="The Address field is required." id="Adress" name="Address" placeholder="Address" required="true" type="text" value="" />
                    
                    <div class="form-control">
                            <input type="hidden" name="type-id" id="type-id" pattern="" />
                            <select class="custom-select donate-type" id="DonateTypeId" name="DonateTypeId" onchange="TypeSelect()" required="required">
                                <option value="" disabled="disabled" selected>Donation Type</option>
                                <?php
                                    $connect = mysqli_connect('localhost','root','');
                                    mysqli_select_db($connect,'orphanage');
                                    //$query = "SELECT * FROM donation_items ORDER BY id ASC";
                                    $result = mysqli_query($connect,"SELECT * FROM donation_items ORDER BY Item_id ASC");
                    ...
                    <div class="form-control">
                            ...
                            <select class="custom-select donate-method" id="DonateMethodId" name="DonateMethodId" onchange="TypeSelect()" required="required">
                                <option value="" disabled="disabled" selected>Donation Method</option>
                                        <option value="1">Fawry</option>
                                        <option value="2">Send Representative</option>
                            </select>
                        </div>
